...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Notes', "Value 1: Notes to change (Dad or BF) Leave blank to change all of them\nValue 2: File name of the new notes \"NOTE_assets\" will give you the default notes"]
	];
